...
#         return lista_proveedores
    ...
    def obtener_metodos_pago_select():
        headers = {'Authorization': 'Bearer '+env("OAUTH2_ACCESS_TOKEN")} 
        response = requests.get('http://127.0.0.1:8080/api/v1/metodos-pago-lista/' ,headers=headers)
    ...
    def obtener_usuario_select():
        headers = {'Authorization': 'Bearer '+env("OAUTH2_ACCESS_TOKEN")} 
        response = requests.get('http://127.0.0.1:8080/api/v1/usuario-lista/' ,headers=headers)
    ...
    def obtener_cliente_select():
        headers = {'Authorization': 'Bearer '+env("OAUTH2_ACCESS_TOKEN")} 
        response = requests.get('http://127.0.0.1:8080/api/v1/clientes-lista/' ,headers=headers)
